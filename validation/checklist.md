...
- `VAL-package-tooling-05`
- `VAL-editor-neovim-01`
- `VAL-editor-neovim-02`
- `VAL-version-manager-01`
- `VAL-version-manager-02`
- `VAL-version-manager-03`
- `VAL-version-manager-05`
...
- `VAL-os-macos-01` (macOS)
- `VAL-os-arch-01` (Arch)
- `VAL-os-arch-02` (Arch)

## Core Recommended Rule IDs
- `VAL-shell-03`
- `VAL-shell-04`
- `VAL-shell-06`
- `VAL-shell-08`
...
## Optional AI Coding Rule IDs
- `VAL-deploy-firebase-01`
- `VAL-deploy-firebase-02`
- `VAL-ai-auth-01`
- `VAL-ai-auth-02`
- `VAL-ai-auth-03`
- `VAL-ai-auth-04`
...
## Completion Criteria
- Core compliant: all core `blocker` IDs pass.
- Profile compliant: all enabled profile `blocker` IDs pass.
- Warnings are either resolved or explicitly accepted and recorded.
